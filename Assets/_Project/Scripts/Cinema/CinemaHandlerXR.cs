...
public class CinemaHandlerXR : MonoBehaviour
{
    ...
    {
        //todo disable all world objects?
        //todo play video from url, if stereo is on set it to TopBottom if not set it to none

        //example
        // mediaplayer.m_StereoPacking = stereo ? StereoPacking.TopBottom : StereoPacking.None;
